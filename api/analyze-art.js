        ...
        try {
            ...
            const response = await axios.post('https://api.anthropic.com/v1/messages', {
                ...
                messages: [{
                    ...
                    content: [{
                        type: 'text',
                        text: 'この絵をかいた子どもを心からほめてください。小学校３年生までの漢字だけを使って、やさしい言葉でお話ししてください。まず「すごいね！」からはじめて、色やかたち、線のかきかたなど、いいところを見つけてほめてください。最後に「これからもがんばってね！」のような応援の言葉でおわってください。150文字くらいのあたたかいメッセージをおねがいします。'
                    }, {
                        type: 'image',
                        source: {
                            type: 'base64',
